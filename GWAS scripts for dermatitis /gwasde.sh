##################################
#GCTA Analysis Script for GWAS -- all patients with dermatitis
##################################
#!/bin/bash
...
--out allde/allde_all_${SGE_TASK_ID} \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--covar /data/scratch/bt23718/GWAS_project/dermatitis_eczema/gsex.txt \
...
# Apply the model to chromosome X data
...
--load-model allde/allde_all_x_model.fastGWA \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--out allde/allde_all_23 \
--thread-num ${NSLOTS} 
