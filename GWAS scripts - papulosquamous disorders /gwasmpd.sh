...
#$ -N malespd                   # Name the job "malespd"
...
--out malespd/malespd_all_${SGE_TASK_ID} \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--qcovar /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/agerectuit.txt \
--remove /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/females.txt
...
--grm-sparse /data/SBBS-FreydinLab/ukbb/genet/plink/grm/ea/ea_sp_grm \
--pheno /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/pap_dis.txt \
--out malespd/malespd_all_x_model \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--remove /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/females.txt \
...
--load-model malespd/malespd_all_x_model.fastGWA \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
