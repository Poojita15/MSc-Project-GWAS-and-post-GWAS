""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
#GCTA Analysis Script for GWAS -- female patients with psoriasis
...
#$ -N femalespd                 # Name the job "femalespd"
...
--out femalespd/femalespd_all_${SGE_TASK_ID} \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--remove /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/males.txt
...
--grm-sparse /data/SBBS-FreydinLab/ukbb/genet/plink/grm/ea/ea_sp_grm \
--pheno /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/pap_dis.txt \
--out femalespd/femalespd_all_x_model \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--remove /data/scratch/bt23718/GWAS_project/papulosquamous_disorders/males.txt \
...
--load-model femalespd/femalespd_all_x_model.fastGWA \
--maf 0.001 \
--geno 0.02 \
--info 0.7 \
--out femalespd/femalespd_all_23 \
--thread-num ${NSLOTS}
